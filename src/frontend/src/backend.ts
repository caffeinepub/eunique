...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: bigint, arg1: string, arg2: bigint, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async isEmailSubscribed(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isEmailSubscribed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitReview(arg0: bigint, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
